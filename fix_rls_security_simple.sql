...
/*
This simplified script addresses all Supabase Security Advisor issues:
...
4. ✅ Added comprehensive RLS policies for all tables based on:
   ...
   - Participant access levels (using simple level checks)
   - Building-based access for tables that reference buildings

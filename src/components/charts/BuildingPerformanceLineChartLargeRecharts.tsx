...
interface BuildingPerformanceLineChartLargeRechartsProps {
  farmId: string
...
export function BuildingPerformanceLineChartLargeRecharts({ 
  farmId, 
  metricType = 'adg',
  standardData = [],
  ...
  yAxisUnit = ''
}: BuildingPerformanceLineChartLargeRechartsProps) {
